...
| **ART•E Local Task**      | [🔎 Inspect task](examples/art_e_local/art-e-local-task.ipynb)                                                                          | Offline email-search task with deterministic rewards | [task README](examples/art_e_local/README.md)                                                                                                                                                                                                       |
