...
| **SFT**             | [SFT from File](https://colab.research.google.com/github/openpipe/art-notebooks/blob/main/examples/sft/train_from_file.ipynb) · [Distillation](https://colab.research.google.com/github/openpipe/art-notebooks/blob/main/examples/sft/distillation.ipynb) · [SFT + RL](https://colab.research.google.com/github/openpipe/art-notebooks/blob/main/examples/sft/sft-rl.ipynb) | Train from file, distill from a teacher, or warm up with SFT then RL | [Link coming soon] |
