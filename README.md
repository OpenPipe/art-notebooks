...
| **Distillation (SFT)**    | [🏋️ Train model](https://colab.research.google.com/github/openpipe/art-notebooks/blob/main/examples/sft/distillation.ipynb)            | Distill text-to-SQL from Qwen 3 235B to Qwen 3.8 27B | [Link coming soon]                                                                                                                                                                                                                                  |
...
Benchmark charts show results from their original runs, not measurements of the current notebook defaults.
